...
public class BuvetteApp1 extends JFrame {
    ...
    outerBox.setLayout(new FlowLayout(FlowLayout.CENTER));
    outerBox.setBackground(new Color(240, 248, 255)); // Light bluish background
    ...
    nameLabel.setForeground(new Color(33, 33, 33)); // Dark gray
    ...
    priceLabel.setForeground(new Color(0, 123, 255)); // Blue
    ...
    card.addMouseListener(new MouseAdapter() {
        @Override
        public void mouseEntered(MouseEvent e) {
            card.setBackground(new Color(224, 255, 255)); // Light cyan
            card.setBorder(BorderFactory.createLineBorder(new Color(30, 144, 255), 2)); // Dodger blue
        }

        @Override
        public void mouseExited(MouseEvent e) {
            card.setBackground(new Color(255, 255, 255, 230));
            card.setBorder(BorderFactory.createLineBorder(new Color(100, 149, 237), 2));
        }
    });
